...
import homeImage from '../Assests/Header.webp'
...
function HomePage() {
  return (
    ...
    <div className="w-1/2 space-y-6">
        ...
        <p className="text-xl text-gray-200">We have a large library of courses taught by highly qualified and skilled faculties at very affordable rate</p>
